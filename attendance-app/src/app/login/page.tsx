    ...
    <div className="min-h-screen flex items-center justify-center bg-brand-50 px-4">
      <div className="w-full max-w-md bg-white rounded-2xl border border-brand-100 shadow-sm p-8">
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-sm text-slate-500 mt-1">Manage students and view attendance</p>
        </div>
        ...
        <p className="mt-6 text-center text-xs text-slate-400">
          Default credentials are set in <code className="bg-slate-100 px-1 rounded">.env</code>
        </p>
      </div>
    </div>
  );
